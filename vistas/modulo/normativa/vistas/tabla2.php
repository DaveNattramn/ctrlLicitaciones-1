...
<script type="text/javascript">
    $(function () {
        if (window.opener != null && !window.opener.closed) {
            ...
            var cDiv = "</div>";
            var panelHead = "<div class='col-md-8 '><div class='panel panel-default normativa'><div class='panel-body'><img class='imagen' src='seinfra.png'></img>     DEPARTAMENTO DE NORMATIVA</div></div>";
            var panelTable = "<div class='panel panel-default'><div class='panel-heading titulo'>";
            var tableBody = "div class='panel-body'><table class='table table-sm'>"
            var TBody = "<tbody>";
            var ctBody = "</tbody>";
            var tr = "<tr>";
            var ctr = "</tr>";
            var tdA = "<td class='atributo'>";
            var tdV = "<td class='valor'>";
            var ctd = "</td>";
